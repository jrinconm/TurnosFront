...
module.exports = function(/* ctx */) {
  return {
    ...
    boot: ["i18n", "axios"],
    bin: {
      linuxAndroidStudio: "/home/julian/android-studio/bin/studio.sh"
    },
    ...
    pwa: {
      ...
      manifest: {
        name: `Turnos Teletrabajo`,
        short_name: `Turnos Teletrabajo`,
        description: `Aplicación para gestionar los turnos de teletrabajo`,
        display: "standalone",
